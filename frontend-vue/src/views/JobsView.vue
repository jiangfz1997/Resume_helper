...
function resetFilters(): void { search.value = ''; runFilter.value = 'all'; eligibility.value = 'actionable'; score.value = 'all'; freshness.value = 'current'; status.value = 'pending' }
</script>
...
.filters { display:grid; grid-template-columns:minmax(250px,1fr) repeat(5,145px); gap:8px; max-width:1500px; margin:auto; padding:10px; border:1px solid var(--border); border-radius:10px; background:rgba(18,21,28,.92); }
