...
class InMemoryJobRepository(JobRepository):
    ...
    def _refresh_record_fields(
        ...
        if eligibility_status != job.eligibility_status or eligibility_codes != job.filter_codes:
            ...
            changed = True
        # A curated new-grad listing is stronger evidence than the absence of
        # deterministic title/JD signals on an older listing. Keep this tag
        # monotonic when cross-source dedup merges the two records.
